#include "intermediatevariant.hpp"
#include "scoring/scoreutils.hpp"

std::vector<double> IntermediateVariant::computeScore(const PlayerBoard& board) const {
    std::vector<double> final_score;
    std::vector<int> points_lookup = {0, 0, 5, 8, 12};
